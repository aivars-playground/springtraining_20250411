...
ALTER TABLE public.events_id_seq OWNER TO test;
...
ALTER TABLE public.organizers OWNER TO test;
...
ALTER TABLE public.organizers_id_seq OWNER TO test;
...
ALTER TABLE public.venues OWNER TO test;
...
ALTER TABLE public.venues_id_seq OWNER TO test;
